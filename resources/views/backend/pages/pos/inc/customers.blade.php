...
<div class="modal-body mb-3">
    <form action="#" class="existing-customer-form">
        @csrf
        <div class="mb-2">
            <label class="form-label">{{ localize('Sélectionner Customer') }}</label>
            <select class="form-select modalSelect2 w-100" name="pos_customer_id" required>
                <option value="">{{ localize('Sélectionner customer from list') }}</option>
...
<div class="modal-body">
    <h2 class="modal-title h5 mb-3" id="addCustomerLabel">{{ localize('Ajouter Nouveau Customer') }}</h1>
        <form action="#" class="pos-new-customer">
            ...
            <div class="row g-3">
                <div class="col-12 col-sm-6">
                    <div class="mb-0">
                        ...
                        <input class="form-control" type="text" id="customerName" name="new_pos_customer_name"
                            placeholder="{{ localize('Saisir customer name') }}" required>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="mb-0">
                        ...
                        <input class="form-control" type="text" id="customerPhone" name="new_pos_customer_phone"
                            placeholder="{{ localize('Saisir customer phone') }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="mb-0">
                        ...
                        <input class="form-control" type="email" id="customerEmail" name="new_pos_customer_email"
                            placeholder="{{ localize('Saisir customer email') }}">
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="mb-0">
                        <button type="submit"
                            class="btn btn-primary save-select-btn">{{ localize('Enregistrer & Select') }}</button>
                    </div>
                </div>
            </div>
        </form>
