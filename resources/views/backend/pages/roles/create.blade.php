                ...
                <form action="{{ route('admin.roles.store') }}" method="POST">
                    ...
                    <div class="card mb-4" id="section-1">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <label for="name" class="form-label">{{ localize('Nom du rôle') }} <span class="text-danger ms-1">*</span></label>
                                <input class="form-control" type="text" id="name" placeholder="{{ localize('Saisir le nom du rôle') }}" name="name" value="{{ old('name') }}" required>
                                @if ($errors->has('name'))
                            ...
                            <div class="tt-page-header" id="section-2">
                                <div class="d-lg-flex align-items-center justify-content-lg-between">
                                    ...
                                    <div class="form-check form-switch">
                                        <label class="form-check-label fw-medium text-primary" for="all_permissions">{{ localize('Sélectionner Tous') }}</label>
                    ...
                    <div class="card mb-4">
                        <div class="card-body group-wrapper">
                            <div class="d-lg-flex align-items-center align-items-center">
                                <label class="form-check-label fs-sm h6 bagde bg-soft-info rounded-pill px-3 p-2 cursor-pointer" for="group-{{ $permission_group[0]['id'] }}">{{ localize('Sélectionner tous de') }}
