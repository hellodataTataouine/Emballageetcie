                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Première section de la bannière') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('admin.appearance.homepage.storeBannerOne') }}" method="POST"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="mb-4">{{ localize('Ajouter Nouvelle bannière') }}</h5>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">{{ localize('Choisir Image de la bannière') }}</span>
                                        <!-- choose media -->
                                    ...
                                    <div>    
                                        <label class="form-label">{{ localize("Taille d'image conseillée : 652px*312px.") }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
