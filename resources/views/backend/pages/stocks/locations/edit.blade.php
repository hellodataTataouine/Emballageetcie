...
@section('title')
    {{ localize('Mettre à jour l\'emplacement') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Mettre à jour l\'emplacement') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="name"
                                        placeholder="{{ localize('Saisir Nom d\'emplacement ') }}" name="name"
                                        value="{{ $location->name }}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="address" class="form-label">{{ localize('Adresse') }}</label>
                                    <textarea class="form-control" id="address" placeholder="{{ localize('Saisir l\'adresse de l\'emplacement ') }}" name="address"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">{{ localize('Choisir la bannière de l\'emplacement') }}</span>
                                        <!-- choose media -->
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-3">{{ localize('Informations sur l\'emplacement ') }}</h5>
