...
@section('title')
    {{ localize('Vérifiez votre numéro de téléphone') }}
@endsection
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                    <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100"
                        ...
                        <h2 class="mb-4 h3">{{ localize('Vérifiez votre numéro de téléphone') }}
                        </h2>
                            ...
                            <div class="col-sm-12">
                                <div class="input-field">
                                    <label class="fw-bold text-dark fs-sm mb-1">{{ localize('Téléphone') }}
                                        ...
                                        <small>({{ localize('Entrez le numéro de téléphone avec le code pays') }})</small></label>
                                    <input type="phone" id="phone" name="phone"
                                        placeholder="{{ localize('Entrez lvotre numéro de téléphone') }}" class="theme-input"
                            ...
                            <div class="col-sm-12">
                                <div class="input-field">
                                    ...
                                    <input type="verification_code" id="verification_code" name="verification_code"
                                        placeholder="{{ localize('Enterz le Code de vérification') }}" class="theme-input">
                                </div>
                            </div>

                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary mt-4">
                                    {{ localize('Vérifiez') }} </button>
                            </div>
                            <p class="mb-0 fs-xs mt-3">{{ localize("n'avez-vous pas reçu de code ?") }} <a
                                    href="">{{ localize('Renvoyer') }}</a></p>
                        </div>
