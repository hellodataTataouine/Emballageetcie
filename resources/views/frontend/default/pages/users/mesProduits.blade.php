...
@section('breadcrumb-contents')
    <div class="breadcrumb-content">
        <h2 class="mb-2 text-center" style="color: #ff7c08;">{{ localize('Mercuriale') }}</h2>
        <nav>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-2">
                        <div class="d-none d-xl-block">
                            @include('frontend.default.pages.products.inc.mercurialeSidebar')
                        </div>
                    ...
                    <div class="col-xl-10">
                        <div class="shop-grid">
                            ...
                            <div class="listing-top d-flex align-items-center justify-content-between flex-wrap gap-3 bg-white rounded-2 px-4 py-4 mb-5">
                                    ...
                                    {{ $mesProduits->firstItem() }}-{{ $mesProduits->lastItem() }} {{ localize('sur ') }}
                                    {{ $mesProduits->total() }} {{ localize('résultat') }}</p>
                                <div
                                ...
                                <a href="#"
                                    ...
                                    {{-- <a href="{{ route('customers.mesProduits') }}?view=grid"
                                    ...
                                    <a href="{{ route('customers.mesProduits') }}?view=list"
                                        class="grid-btn {{ request()->view == 'list' ? 'active' : '' }} d-none d-xl-flex">
                                        <svg width="21" height="16" viewBox="0 0 21 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
...
@section('scripts')
    <script>
        ...
        var view = $(this).data('view');
            ...
            var url = '{{ route('customers.mesProduits') }}?category_id=' + categoryId + '&per_page=' + perPage + '&sort_by=' + sortBy + '&view=' + view;
