                ...
                <div class="col-xl-6">
                    <div class="content-404 text-center">
                        <img src="{{ staticAsset('frontend/default/assets/img/404.png') }}" alt="not found"
                            class="img-fluid">
                            <h2 class="mt-4">Désolé, une erreur s'est produite</h2>
                    <p class="mb-6">La page que vous recherchez pourrait avoir été supprimée, avoir changé de nom ou être temporairement inaccessible.</p>
